...
there. This module knows Brave-specific
...
provide `cdp_access` (Chrome ships the same shape), the user's default
...
def _brand_profile() -> None:
    ...
    never confused with the human's own Brave. Chromium persists the
