...
This is implemented in `apps/cross-platform/goodreads/public_graph.py`.
...
- `apps/cross-platform/goodreads/public_graph.py` — all public data operations and runtime discovery

Primary app definition:

- `apps/cross-platform/goodreads/readme.md`
